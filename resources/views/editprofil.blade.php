    ...
    <div class="edit-container">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" id="class" placeholder="Masukkan kelas" required>
            </div>
            <a href="profil.html" class="btn-sve">Simpan Perubahan</a>
            <a href="profil.html" class="btn-cancel">Batal</a>
