    ...
    <style>
        * {
        ...
        .logout-btn {
            ...
            /* Warna default untuk tombol lainnya */
            color: white;
            padding: 12px 25px;
            border: none;
            border-radius: 5px;
...
<body>
    ...
    <div class="profile-container">
        ...
        <img src="logoMP.jpeg" alt="Profile Picture" class="profile-picture">

        <!-- Detailed information -->
        <div class="profile-details">
            <p><strong>Nama:</strong>jojon</p>
        ...
        <div class="profile-actions">
            <a href="Edit.html" class="btn">Edit Profil</a>
